...
(function(){var a=document.getElementById("style"),b=document.querySelectorAll(".theme"),d=new Date;d.setFullYear(d.getFullYear()+1);var c={};b=$jscomp.makeIterator(b);for(var e=b.next();!e.done;c={tb:c.tb},e=b.next())c.tb=e.value,c.tb.addEventListener("click",function(b){return function(){var c=b.tb.dataset.theme.match(/\/([a-z]+)\./g);c=(""+c).replace(/[^\w]/gi,"");document.cookie="theme="+c+"; expires="+d.toUTCString()+"; path=/";a.href="assets/"+b.tb.dataset.theme+".min.css"}}(c))})();
